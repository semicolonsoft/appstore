...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'appstore.exception_handler.exception_handlers',
...
ASGI_APPLICATION = "appstore.asgi.application"
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'appstore/statics')
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'appstore/media')
